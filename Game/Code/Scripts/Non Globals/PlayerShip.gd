...
func apply_cumulative_rotation():
...
func apply_rotation():
	...
	var rotated_basis = self.transform.basis.rotated(axis_y, net_input_horizontal).rotated(axis_x, net_input_vertical).rotated(axis_z, net_input_rotational)
